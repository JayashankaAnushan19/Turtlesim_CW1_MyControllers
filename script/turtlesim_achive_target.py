...
def init_node():
    ...
    # Subscriber to catch the current position
...
def direct_distance(target_pose):
    # Calculate the distance between target and current positions using Pythagorean theorem
...
def angular_vel(target_pose, constant=6):
    # Calculate the angular velocity based on the difference in the angles
...
def main():
    try:
        ...
        while not rospy.is_shutdown():
            ...
            # Get user input for the goal coordinates
